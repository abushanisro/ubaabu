...
* **Headings:** Use Title Case for H1/H2. Use sentence case for H3+.
...
| "Solutions" (generic) | Specific module name (e.g. "Should-Cost Engine") |
| "AI-powered" (alone) | Describe what the AI actually does |
| "World-class" | Specific metric or outcome |
...
## Hero Copy Pattern
```
[Action verb]. [Action verb]. [Outcome verb].
[Teal accent line]
```
