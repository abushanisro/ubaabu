                  ...
                  >
                    <foreignObject x={startPoint.x - 50} y={startPoint.y - 35} width="100" height="30">
                      <div className="flex items-center justify-center h-full">
                        <span className="text-[10px] font-medium px-1.5 py-0.5 rounded bg-white/95 text-black border border-gray-200 shadow-sm whitespace-nowrap">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
      ...
      <AnimatePresence>
        {hoveredLocation && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: 10 }}
            className="absolute bottom-4 left-4 bg-white/90 text-black px-3 py-2 rounded-lg text-xs font-medium backdrop-blur-sm sm:hidden border border-gray-200"
          >
            {hoveredLocation}
          </motion.div>
        )}
