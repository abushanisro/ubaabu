    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="mx-auto max-w-[1160px] px-6 md:px-12 py-14 flex flex-col lg:flex-row gap-14 lg:gap-20">
        ...
        <article className="flex-1 min-w-0">
          ...
          <Para>
            We recommend reviewing this page periodically. The current version is always available at <TealLink href="/cookies">emithran.in/cookies</TealLink>. Archived versions of this policy can be requested by emailing <TealLink href="mailto:contact@emithran.com">contact@emithran.com</TealLink>.
          </Para>
          <Para>
