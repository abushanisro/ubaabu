...
// Hand-built /emithran-vs-<slug> comparison pages (sibling directories under src/app, not
// routed through the SEO_LANDING_PAGES [slug] factory). Both sitemap.ts and SiteJsonLd.tsx
// import this single list so adding a new comparison page only requires one edit here plus
// the new page directory itself.
...
const glossarySeed = [
  ...
  'manufacturing process library', 'manufacturing process', 'manufacturing cost estimation', 'reverse auction',
  'direct and indirect manufacturing costs', 'design for excellence', 'geometric dimensioning and tolerancing',
  'commodity price index', 'CAD costing', 'sheet metal costing',
...
const glossaryDefinitions: Record<string, string> = {
  ...
  'manufacturing process': 'The specific method, such as machining, casting, forging, moulding, or welding, used to convert raw material into a finished part or component, each with its own cost, tolerance, and volume characteristics.',
  'manufacturing cost estimation': 'The practice of predicting what a part or assembly will cost to produce before it is sourced or manufactured, using process, material, labor, and overhead assumptions rather than waiting for a supplier quote.',
  'reverse auction': 'A competitive sourcing event where qualified suppliers bid against each other in real time to win a contract, with price typically decreasing as the auction progresses, used to drive down cost on well-specified, multi-source parts.',
  'direct and indirect manufacturing costs': 'Direct costs, such as material and direct labor, can be traced to a specific part; indirect costs, such as facility overhead and supervision, are shared across production and allocated across parts or runs.',
  'design for excellence': 'An umbrella engineering practice, often abbreviated DFX, that evaluates a design against multiple objectives at once, such as manufacturability, cost, quality, serviceability, and sustainability, rather than optimizing for one in isolation.',
  'geometric dimensioning and tolerancing': 'A symbolic system, often abbreviated GD&T, for specifying and communicating a part’s allowable variation in form, orientation, and location, directly affecting manufacturing process selection and cost.',
...
// 1-2 contextual links per term to the most relevant pillar/comparison/case-study page.
// Terms not listed here render with no "see also" links rather than a forced, irrelevant one.
const glossaryRelatedLinks: Record<string, { href: string; label: string }[]> = {
  'should cost analysis': [{ href: '/should-cost-analysis-software', label: 'Should-Cost Analysis Software' }],
  'BOM management': [{ href: '/bom-management-software', label: 'BOM Management Software' }],
  'supplier intelligence': [{ href: '/supplier-intelligence', label: 'Supplier Intelligence' }],
  'strategic sourcing': [{ href: '/strategic-sourcing-software', label: 'Strategic Sourcing Software' }],
  'SRM': [{ href: '/srm-software', label: 'SRM Software' }],
  'spend analysis': [{ href: '/spend-analysis-software', label: 'Spend Analysis Software' }],
  'cost engineering': [{ href: '/cost-engineering-software', label: 'Cost Engineering Software' }],
  'design for manufacturability': [{ href: '/design-for-manufacturability-software', label: 'Design for Manufacturability Software' }],
  'VAVE': [{ href: '/vave-software', label: 'VAVE Software' }],
  'RFQ': [{ href: '/rfq-intelligence', label: 'RFQ Intelligence' }],
  'design to cost': [{ href: '/design-to-cost-software', label: 'Design-to-Cost Software' }],
  'aerospace manufacturing': [{ href: '/aerospace-cost-engineering', label: 'Aerospace Cost Engineering' }],
  'defence manufacturing': [{ href: '/defence-manufacturing', label: 'Defence Manufacturing' }],
  'supply chain risk': [{ href: '/supply-chain-intelligence', label: 'Supply Chain Intelligence' }],
  'manufacturing benchmarking': [{ href: '/manufacturing-benchmarking', label: 'Manufacturing Benchmarking' }],
  'total cost of ownership': [{ href: '/total-cost-ownership', label: 'Total Cost of Ownership Guide' }],
  'process routing': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'manufacturing process': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'manufacturing cost estimation': [{ href: '/should-cost-analysis-software', label: 'Should-Cost Analysis Software' }],
  'reverse auction': [{ href: '/strategic-sourcing-software', label: 'Strategic Sourcing Software' }],
  'direct and indirect manufacturing costs': [{ href: '/cost-engineering-software', label: 'Cost Engineering Software' }],
  'design for excellence': [{ href: '/design-for-manufacturability-software', label: 'Design for Manufacturability Software' }],
  'geometric dimensioning and tolerancing': [{ href: '/aerospace-cost-engineering', label: 'Aerospace Cost Engineering' }],
  'machine hourly rate': [{ href: '/cost-engineering-software', label: 'Cost Engineering Software' }],
  'landed cost': [{ href: '/case-studies/chassis-india-belgium', label: 'India vs Belgium Landed Cost Case Study' }],
  'dual sourcing': [{ href: '/supply-chain-intelligence', label: 'Supply Chain Intelligence' }],
  'single source risk': [{ href: '/supply-chain-intelligence', label: 'Supply Chain Intelligence' }],
  'supplier qualification': [{ href: '/srm-software', label: 'SRM Software' }],
  'cost breakdown analysis': [{ href: '/blog/cost-breakdown-analysis', label: 'Cost Breakdown Analysis Guide' }],
  'MRO spend': [{ href: '/spend-analysis-software', label: 'Spend Analysis Software' }],
  'vendor negotiation': [{ href: '/should-cost-analysis-software', label: 'Should-Cost Analysis Software' }],
  'AI sourcing': [{ href: '/procurement-intelligence', label: 'Procurement Intelligence' }],
  'global strategic sourcing': [{ href: '/strategic-sourcing-software', label: 'Strategic Sourcing Software' }],
  'aPriori alternative': [{ href: '/emithran-vs-apriori', label: 'Emithran vs aPriori' }],
  ...
  'cost driver': [{ href: '/cost-engineering-software', label: 'Cost Engineering Software' }],
  'manufacturing intelligence': [{ href: '/manufacturing-intelligence', label: 'Manufacturing Intelligence Platform' }],
  'digital twin manufacturing': [{ href: '/blog/digital-twin-in-manufacturing', label: 'Digital Twin in Manufacturing' }],
  'precision manufacturing': [{ href: '/manufacturing-intelligence', label: 'Manufacturing Intelligence Platform' }],
  'CMMC manufacturing': [{ href: '/defense-manufacturing-software', label: 'Defense Manufacturing Software' }],
  'defence procurement': [{ href: '/defence-manufacturing', label: 'Defence Manufacturing' }],
  'spend opportunity assessment': [{ href: '/spend-analysis-software', label: 'Spend Analysis Software' }],
  'procurement consulting': [{ href: '/procurement-intelligence', label: 'Procurement Intelligence' }],
  'international procurement': [{ href: '/strategic-sourcing-software', label: 'Strategic Sourcing Software' }],
  'manufacturing process library': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'commodity price index': [{ href: '/spend-analysis-software', label: 'Spend Analysis Software' }],
  'CAD costing': [{ href: '/should-cost-analysis-software', label: 'Should-Cost Analysis Software' }],
  'sheet metal costing': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'CNC machining cost': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'casting cost': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'forging cost': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'injection moulding cost': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'PCBA costing': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'wire harness costing': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'tooling amortisation': [{ href: '/cost-engineering-software', label: 'Cost Engineering Software' }],
  'cycle time': [{ href: '/manufacturing-process-library', label: 'Manufacturing Process Library' }],
  'overhead allocation': [{ href: '/cost-engineering-software', label: 'Cost Engineering Software' }],
  'supplier capacity': [{ href: '/supplier-intelligence', label: 'Supplier Intelligence' }],
  'supplier scorecard': [{ href: '/srm-software', label: 'SRM Software' }],
  'NADCAP': [{ href: '/aerospace-cost-engineering', label: 'Aerospace Cost Engineering' }],
  'AS9100': [{ href: '/aerospace-cost-engineering', label: 'Aerospace Cost Engineering' }],
  'export control': [{ href: '/defence-manufacturing', label: 'Defence Manufacturing' }],
  'ITAR': [{ href: '/defence-manufacturing', label: 'Defence Manufacturing' }],
  'DDP logistics': [{ href: '/case-studies/chassis-india-belgium', label: 'India vs Belgium Landed Cost Case Study' }],
  'EXW pricing': [{ href: '/should-cost-analysis-software', label: 'Should-Cost Analysis Software' }],
  'make vs buy': [{ href: '/case-studies/hgv-cab-strategy', label: 'HGV Cab Make-vs-Buy Case Study' }],
  'teardown analysis': [{ href: '/case-studies/electronics-teardown', label: 'Electronics Teardown Case Study' }],
  'reverse BOM': [{ href: '/case-studies/electronics-teardown', label: 'Electronics Teardown Case Study' }],
  'target costing': [{ href: '/design-to-cost-software', label: 'Design-to-Cost Software' }],
  'should cost model': [{ href: '/should-cost-analysis-software', label: 'Should-Cost Analysis Software' }],
  'procurement savings': [{ href: '/spend-analysis-software', label: 'Spend Analysis Software' }],
  'manufacturing analytics': [{ href: '/manufacturing-intelligence', label: 'Manufacturing Intelligence Platform' }],
  'supplier resilience': [{ href: '/supply-chain-intelligence', label: 'Supply Chain Intelligence' }],
  'cost avoidance': [{ href: '/spend-analysis-software', label: 'Spend Analysis Software' }],
  'engineering change cost': [{ href: '/bom-management-software', label: 'BOM Management Software' }],
  'programme sourcing': [{ href: '/strategic-sourcing-software', label: 'Strategic Sourcing Software' }],
}
...
export const GLOSSARY_TERMS = glossarySeed.map((term) => {
  ...
  return {
    ...
    relatedLinks: glossaryRelatedLinks[term] ?? [],
  }
})
