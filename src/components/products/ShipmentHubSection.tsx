            ...
            <div className="lg:sticky lg:top-28">
              ...
              >
                <svg width="26" height="26" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style={{ overflow: 'visible' }}>
                  <rect x="4" y="15" width="9" height="9" rx="2" fill="#0d9488" />
                  <rect x="16" y="7" width="9" height="9" rx="2" fill="#2dd4bf" />
                  <rect x="27" y="23" width="9" height="9" rx="2" fill="#0f1b2d" opacity="0.7" />
                  <rect x="13" y="19" width="3" height="2" rx="1" fill="#0d9488" opacity="0.45" />
                  <rect x="20" y="16" width="7" height="2" rx="1" fill="#2dd4bf" opacity="0.5" />
                  <rect x="25" y="20" width="2" height="3" rx="1" fill="#0f1b2d" opacity="0.35" />
                </svg>
              </motion.div>
