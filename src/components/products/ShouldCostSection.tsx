            ...
            <div className="lg:sticky lg:top-28">
              ...
              >
                <svg width="26" height="26" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style={{ overflow: 'visible' }}>
                  ...
                  <rect x="6" y="22" width="7" height="12" rx="2" fill="#0d9488" opacity="0.7" />
                  <rect x="16" y="12" width="7" height="22" rx="2" fill="#2dd4bf" />
                  <rect x="26" y="18" width="7" height="16" rx="2" fill="#0d9488" />
                  <rect x="4" y="16" width="32" height="1.5" rx="0.75" fill="#0f1b2d" opacity="0.2" />
                </svg>
              </motion.div>
