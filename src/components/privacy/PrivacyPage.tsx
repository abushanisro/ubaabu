      ...
      <div className="mx-auto max-w-[1160px] px-6 md:px-12 py-14 flex flex-col lg:flex-row gap-14 lg:gap-20">
        ...
        <article className="flex-1 min-w-0">
          ...
          <Ul items={[
            ...
            <><Bold>Opt out of marketing</Bold> — unsubscribe from marketing emails at any time via the unsubscribe link in any email or by contacting us at <TealLink href="mailto:privacy@emithran.in">privacy@emithran.in</TealLink></>,
          ]} />
          <Para>
            To exercise any right, email <TealLink href="mailto:privacy@emithran.in">privacy@emithran.in</TealLink>. We will respond within 30 days, or within the period required by applicable law. We may need to verify your identity before acting on your request.
          </Para>
          <Divider />
          ...
          <Para>
            While we take reasonable precautions, no system is completely secure. If you believe your account has been compromised, contact us immediately at <TealLink href="mailto:security@emithran.in">security@emithran.in</TealLink>.
          </Para>
          <Divider />
          ...
          <Para>
            You may request a copy of the applicable transfer mechanism by emailing <TealLink href="mailto:privacy@emithran.in">privacy@emithran.in</TealLink>.
          </Para>
          <Divider />
          ...
          <Para>
            To raise a grievance under the DPDPA, contact our Grievance Officer at <TealLink href="mailto:grievance@emithran.in">grievance@emithran.in</TealLink>. Grievances will be acknowledged within 48 hours and resolved within 30 days. If you remain dissatisfied, you may approach the Data Protection Board of India.
          </Para>
          ...
          <Para>
            Our EU GDPR representative can be reached at <TealLink href="mailto:eu-rep@emithran.in">eu-rep@emithran.in</TealLink>.
          </Para>

          <SubHeading id="usa">United States</SubHeading>
          <Para>
            For <Bold>California residents</Bold>, under the California Consumer Privacy Act (CCPA) as amended by the CPRA, you have the right to know, delete, and opt out of the sale or sharing of personal information. We do not sell personal information as defined under the CCPA. To submit a CCPA request, email <TealLink href="mailto:privacy@emithran.in">privacy@emithran.in</TealLink> with &ldquo;CCPA Request&rdquo; in the subject line.
          </Para>
          <Para>
            For <Bold>Virginia, Colorado, and Connecticut residents</Bold>, we comply with the respective state consumer data protection laws. You have the right to access, correct, delete, and opt out of targeted advertising. Submit requests to <TealLink href="mailto:privacy@emithran.in">privacy@emithran.in</TealLink>.
          </Para>

          <SubHeading id="australia">Australia</SubHeading>
          <Para>
            For Australian residents, we comply with the <Bold>Privacy Act 1988 (Cth)</Bold> and the Australian Privacy Principles (APPs). You have the right to access and correct personal information we hold about you. To make a complaint or access request, email <TealLink href="mailto:privacy@emithran.in">privacy@emithran.in</TealLink>. If your complaint is not resolved to your satisfaction, you may lodge a complaint with the Office of the Australian Information Commissioner (OAIC) at oaic.gov.au.
          </Para>
          <Divider />
          ...
          >
            ...
            <div className="p-5 flex flex-col gap-3" style={{ background: '#fff' }}>
              {[
                ...
                { label: 'Grievance Officer (India)',email: 'grievance@emithran.in'},
                { label: 'EU Representative',        email: 'eu-rep@emithran.in'   },
              ].map(row => (
