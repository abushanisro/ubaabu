...
const CASE_STUDIES = [
  {
    title: "Tier-1 Supplier Cuts BOM Errors by 94% with Automated Validation",
    date: "June 2, 2026",
    body: "A Chennai-based Tier-1 automotive supplier reduced BOM line-item errors from 6% to 0.4%, preventing production delays worth millions before they happened.",
    bg: '#f0fdf9',
    border: 'rgba(13,148,136,0.15)',
    tag: 'Engineering',
    href: '/case-studies/bom-accuracy-tier1',
  },
  {
    title: "Defence Manufacturer Achieves 100% PPAP Compliance Across 3 Programs",
    date: "May 20, 2026",
    body: "Using Supplier Radar and Quality Guard, a defence OEM mapped certification traceability across 200+ suppliers and hit zero non-conformances on audit.",
    bg: '#0f1b2d',
    border: 'rgba(45,212,191,0.2)',
    tag: 'Industry',
    href: '/case-studies/defence-ppap-compliance',
    dark: true,
  },
  {
    title: "Should-Cost Engine Saves OEM 23% on Annual Procurement Spend",
    date: "May 12, 2026",
    body: "Real cost intelligence gave procurement teams negotiation leverage that market quotes never could. Win rates on RFQs improved by 31% in the first quarter.",
    bg: '#ccfbf1',
    border: 'rgba(13,148,136,0.2)',
    tag: 'Product',
    href: '/case-studies/should-cost-oem-savings',
  },
  {
    title: "VAVE Studio Cuts Aerospace Component Cost by 18% Without Spec Changes",
    date: "April 30, 2026",
    body: "A Tier-2 aerospace supplier used VAVE Studio to identify 47 value engineering opportunities across an active program, delivering 18% cost reduction.",
    bg: '#e6faf7',
    border: 'rgba(13,148,136,0.15)',
    tag: 'Engineering',
    href: '/case-studies/vave-aerospace-cost',
  },
  {
    title: "Indian Tier-2 Wins Global OEM Contract Using Supplier Intelligence",
    date: "April 5, 2026",
    body: "Emithran's Supplier Radar helped a precision manufacturer demonstrate compliance, delivery history, and certification depth — winning a contract with a European Tier-1.",
    bg: '#0d9488',
    border: 'rgba(255,255,255,0.15)',
    tag: 'Corporate',
    href: '/case-studies/tier2-global-oem',
    dark: true,
  },
  {
    title: "Shipment Hub Drives 98.6% OTIF for High-Volume Space Components",
    date: "March 22, 2026",
    body: "End-to-end shipment visibility and automated alerts helped a space component manufacturer consistently hit world-class OTIF — across 12 active customer programs.",
    bg: '#f0fdf9',
    border: 'rgba(13,148,136,0.15)',
    tag: 'Product',
    href: '/case-studies/shipment-hub-otif',
  },
]
