  ...
  return (
    <CaseStudyShell
      ...
      stats={[
        ...
        { label: 'Assembly Cost',   value: 'â‚¬5,248.81' },
        { label: 'Belgium Rail',    value: 'â‚¬872 / unit' },
        { label: 'India Rail DDP',  value: 'â‚¬538 / unit' },
    ...
    >
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card accent>
          ...
          <h2 className="mb-4 text-[17px] font-bold text-[#0f1b2d]">Assy Chassis Ladder Frame Â· HGV 4Ã—2 4M</h2>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card accent>
          <SectionLabel>Assembly Cost Breakdown - Belgium Â· â‚¬5,248.81</SectionLabel>
            ...
            {[
              ...
              <div key={item.label}>
                <div className="mb-1.5 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-[11px] text-black/30">â‚¬{item.val.toLocaleString()}</span>
          ...
          <div className="divide-y divide-black/[0.06] border-t border-black/[0.06] pt-4">
            {[
              { k: 'Total Manufacturing Cost', v: 'â‚¬4,337.85', bold: false },
              { k: 'SG&A (10%)',               v: 'â‚¬433.78',   bold: false },
              { k: 'Profit (10%)',              v: 'â‚¬477.16',   bold: false },
              { k: 'Total Cost / Assembly',     v: 'â‚¬5,248.81', bold: true  },
            ].map(({ k, v, bold }) => (
                ...
                <div className="flex flex-wrap gap-2">
                  {s.ops.map((op) => (
                    <span key={op.name} className="rounded-lg border border-black/[0.07] bg-[#f8fafb] px-2.5 py-1.5 text-[12px]">
                      ...
                      <span className="ml-1.5 font-bold" style={{ color: s.color }}>Ã—{op.n}</span>
                    </span>
                  ))}
                </div>
              </div>
        ...
        <div className="space-y-2">
          {[
            ...
            <div key={item.part} className="flex items-center gap-3">
              ...
              <span className="w-16 shrink-0 text-right text-[12px] text-black/40">â‚¬{item.cost.toFixed(2)}</span>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card accent>
          ...
          <h2 className="mb-1 text-[17px] font-bold text-[#0f1b2d]">â‚¬396.73 Ex Works Â· Roll Forming Process</h2>
          <p className="mb-4 text-[12px] text-black/40">Part 105002654/55 Â· 156.5 kg finish Â· 247.28 kg input</p>
          <div className="space-y-3 mb-5">
            {[
              { label: 'Raw Material Cost', val: 'â‚¬222.55', pct: 56, color: '#0d9488',  note: 'Primary driver - 56% of manufacturing' },
              { label: 'SG&A + Profit',     val: 'â‚¬68.85',  pct: 27, color: '#94a3b8', note: 'Higher share due to lower process base' },
              { label: 'Process Cost',      val: 'â‚¬105.33', pct: 17, color: '#60a5fa', note: 'Only 6% of mfg cost - roll forming efficiency' },
            ].map((item) => (
              <div key={item.label}>
          ...
          <div className="rounded-xl bg-[#f8fafb] border border-black/[0.06] px-4 py-3 divide-y divide-black/[0.06]">
            {[
              { k: 'Total Manufacturing Cost', v: 'â‚¬327.88', bold: false },
              { k: 'SG&A (10%)',               v: 'â‚¬32.79',  bold: false },
              { k: 'Profit (10%)',              v: 'â‚¬36.07',  bold: false },
              { k: 'Ex Works Cost / Piece',     v: 'â‚¬396.73', bold: true  },
            ].map(({ k, v, bold }) => (
        ...
        <Card>
          <SectionLabel>DDP Cost - Chennai â†’ Scotland</SectionLabel>
          <h2 className="mb-4 text-[17px] font-bold text-[#0f1b2d]">â‚¬141.50 per unit delivered</h2>
          <div className="mb-4 grid grid-cols-2 gap-2 text-[12px]">
            {[
              ...
              { k: 'Part Dims',     v: '6,269 Ã— 287 Ã— 80 mm' },
          ...
          <div className="space-y-1.5 divide-y divide-black/[0.04]">
            {[
              { k: 'Packing Cost',              v: 'â‚¬204.78 / shipment' },
              { k: 'Local Transport (India)',    v: 'â‚¬163.83' },
              { k: 'IHC / THC Charges',         v: 'â‚¬66.18' },
              { k: 'Sea Freight',               v: 'â‚¬49.82 (18 â‚¬/CBM)' },
              { k: 'Import Duties',             v: 'â‚¬118.80' },
              { k: 'Local Delivery (Scotland)', v: 'â‚¬725.00' },
              { k: 'DDP Handling + Insurance',  v: 'â‚¬348.33' },
            ].map(({ k, v }) => (
          ...
          <div className="mt-3 flex justify-between rounded-xl bg-[#f0fdfb] border border-[#0d9488]/20 px-4 py-3">
            ...
            <span className="text-[16px] font-bold text-[#0d9488]">â‚¬141.50</span>
          </div>
        </Card>
      </div>
      ...
      <div>
        ...
        <h2 className="mb-6 text-xl font-bold text-[#0f1b2d]">India total landed cost: â‚¬538 vs Belgium: â‚¬872</h2>
        ...
        <div className="grid gap-4 md:grid-cols-2 mb-6">
          <div className="rounded-2xl border border-black/[0.07] bg-white p-6 shadow-sm">
            ...
            <p className="text-[32px] font-bold text-[#0f1b2d]">â‚¬872</p>
            <p className="mb-4 text-[12px] text-black/40">Ex Works Â· SG&A + Profit only</p>
            <div className="space-y-2 text-[13px]">
              {[
                { k: 'Raw Material', v: 'â‚¬267' },
                { k: 'Process Cost', v: 'â‚¬454' },
                { k: 'SG&A + Profit',v: 'â‚¬151' },
              ].map(({ k, v }) => (
          ...
          <div className="rounded-2xl border border-[#0d9488]/30 bg-[#f0fdfb] p-6 shadow-sm ring-1 ring-[#0d9488]/15">
            <p className="mb-1 text-[11px] font-semibold uppercase tracking-wider text-[#0d9488]/70">India DDP Â· Recommended</p>
            <p className="text-[32px] font-bold text-[#0d9488]">â‚¬538</p>
            <p className="mb-4 text-[12px] text-black/40">DDP Scotland Â· Includes full logistics</p>
            <div className="space-y-2 text-[13px]">
              {[
                { k: 'Raw Material', v: 'â‚¬223', delta: 'âˆ’17% vs Belgium' },
                { k: 'Process Cost', v: 'â‚¬105', delta: 'âˆ’77% vs Belgium' },
                { k: 'DDP + SG&A',  v: 'â‚¬210', delta: '+39% (logistics overhead)' },
              ].map(({ k, v, delta }) => (
        ...
        <Card>
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            {[
              { label: 'Process cost saving',    pct: 'âˆ’77%', desc: 'Roll forming in India vs fabrication in Belgium - the single biggest driver of total savings', color: '#0d9488' },
              { label: 'Material cost saving',   pct: 'âˆ’17%', desc: 'Lower raw material rates in India despite same grades (HR 600MC, S460N)', color: '#60a5fa' },
      ...
      <DarkCard>
        ...
        <ImpactGrid items={[
          { num: '38%',    title: 'Total Landed Cost Saving',   desc: 'India DDP (â‚¬538) vs Belgium Ex Works (â‚¬872) - despite full sea freight, import duties, and last-mile delivery.' },
          { num: 'âˆ’77%',   title: 'Process Cost Reduction',     desc: 'Roll forming in India is dramatically more efficient than Belgium fabrication for this chassis rail profile.' },
          { num: 'â‚¬141',   title: 'DDP Fully Modelled',         desc: 'Packing, local freight, sea freight, IHC/THC, insurance, import duty, and door delivery to Scotland all costed.' },
