      ...
      <div className="mx-auto max-w-[1280px] px-6 py-14 md:px-12 md:py-20 space-y-10">
        ...
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-black/[0.07] bg-white px-6 py-10 text-center shadow-sm">
          ...
          <div className="mt-2 flex flex-wrap justify-center gap-3">
            ...
            <a href="/contact?source=case-study-hgv-cab-strategy&cta=contact-sales" className="rounded-lg border border-black/15 px-5 py-2.5 text-[13px] font-semibold text-[#0d1117] hover:bg-black/[0.04] transition-colors">
              Contact Sales
            </a>
          </div>
        </div>
