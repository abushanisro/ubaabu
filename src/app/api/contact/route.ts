    ...
    const html = `
      ...
      <body style="font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;max-width:640px;margin:0 auto;padding:32px 16px;background:#fff;color:#111827;">
        <div style="margin-bottom:32px;">
          ...
          <h1 style="margin:20px 0 4px;font-size:22px;font-weight:700;color:#0f1b2d;">New Contact Request</h1>
          <p style="margin:0;font-size:13px;color:#6b7280;">Submitted via emithran.in/contact</p>
        </div>
        ...
        <p style="font-size:11px;color:#9ca3af;border-top:1px solid #f3f4f6;padding-top:16px;margin-top:32px;">
          Emithran Manufacturing Intelligence · emithran.in/contact
        </p>
      </body>
      </html>`
